...
public class AudioHandler extends AudioEventAdapter implements AudioSendHandler 
{
    ...
    public MessageEditData getNowPlaying(JDA jda)
    {
        if(isMusicPlaying(jda))
        {
            ...
            return new MessageEditBuilder().setContent((FormatUtil.filter(manager.getBot().getConfig().getSuccess()+" **Now Playing in "+guild.getSelfMember().getVoiceState().getChannel().getAsMention()+"...**")))
